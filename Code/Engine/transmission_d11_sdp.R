## 1 Nov 2014: Rewrite transmission function for SDP
...
##   ### Extract partnership network
  ...
  function(nw, verbose,
       ...
       ## decline in infectivity for known-sdps with positive male
       ...
       ## decline in infectivity for known-sdps with positive female
       discordant.fpos.known.longest.sdp <- intersect(discordant.fpos,
                                                         known.longest.sdp.true)

       transmittable.f.known.longest.sdp <- nw.el[discordant.mpos.known.longest.sdp,
                                                  2]
